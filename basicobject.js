...
//Object.seal(obj) - Seals an object, preventing new properties from being added but allowing modifications to existing properties.
// const obj = { a: 1 };
// Object.seal(obj);
// obj.a = 2; // Works
...
//Object.is(value1, value2) - Determines if two values are the same (more precise than ===).
...
//Object.hasOwn(obj, prop) - Returns true if the object has the specified property as its own (not inherited).
const obj = { a: 1 };
